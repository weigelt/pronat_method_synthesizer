...
public class IntegrationTest {
	...
	public void runAllTexts() throws IOException {
		String[] inputs = new String[] { "6",
				"i armar starting the dishwasher means you must close the dishwasher door then press the blue button two times", "9",
				...
				"36", "hi starting the dishwasher means closing the dishwasher and pressing the blue button twice", "34",
				...
				"41", "to start the dishwasher you have to press the blue button twice and after that close the dishwasher", "55",
				"close the dishwasher and press the blue button two times", "49",
				...
				"58", "hi armar turn on the dishwasher means press twice blue button while dishwasher is closed", "67",
	...
	public void mockMclassTest() {
		...
		String input = inputData.getLeft();
		...
		List<MulticlassLabels> mockMclassPrediction = inputData.getRight();
	...
	private Pair<String, List<MulticlassLabels>> longSequence() {
		...
		List<MulticlassLabels> mockMclassPrediction = new ArrayList<>(Arrays.asList(MulticlassLabels.DECL, MulticlassLabels.DECL,
	...
	private Pair<String, List<MulticlassLabels>> modalVerbSequence() {
		...
		List<MulticlassLabels> mockMclassPrediction = new ArrayList<>(Arrays.asList(MulticlassLabels.DECL, MulticlassLabels.DESC,
				MulticlassLabels.DECL, MulticlassLabels.DECL, MulticlassLabels.DECL, MulticlassLabels.DECL,
	...
	private Pair<String, List<MulticlassLabels>> elseSequence() {
		...
		List<MulticlassLabels> mockMclassPrediction = new ArrayList<>(Arrays.asList(MulticlassLabels.ELSE, MulticlassLabels.ELSE,
				MulticlassLabels.ELSE, MulticlassLabels.ELSE, MulticlassLabels.ELSE, MulticlassLabels.ELSE, MulticlassLabels.ELSE,
				MulticlassLabels.ELSE, MulticlassLabels.ELSE, MulticlassLabels.ELSE,
	...
	private Pair<String, List<MulticlassLabels>> elaborationSequence() {
		...
		List<MulticlassLabels> mockMclassPrediction = new ArrayList<>(
				Arrays.asList(MulticlassLabels.DECL, MulticlassLabels.DECL, MulticlassLabels.DECL, MulticlassLabels.DECL,
						MulticlassLabels.DECL, MulticlassLabels.DECL, MulticlassLabels.DECL, MulticlassLabels.DECL,
