...
public class MethodSignatureCandidate {
	...
	public MethodSignatureCandidate(String methodName, List<FunctionParameterCandidate> parameters, AbstractInstruction instruction) {
	...
	public List<FunctionParameterCandidate> getParameters() {
		return parameters;
	}
