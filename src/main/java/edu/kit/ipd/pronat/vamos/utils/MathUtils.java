...
public class MathUtils {
	...
	/**
	 * Recursive implementation of the cartesian product. Creates every combination
	 * of candidates, preserving the different DescriptionParameter chunks. Example:
	 * param1 [a,b] and param2 [c,d] -> candidates [a,c] [a,d] [b,c] [b,d]
	 * Constraint: 2 elements per chunk
	 *
	 * @param lists
	 *            of (here param) candidates in their separated chunks
	 ...
	 * Constraint: All elements of LEFT are fixed. There need to be found all
	 * combinations of RIGHT to LEFT. See @link
	 * edu.kit.ipd.parse.vamos.OntologyMapperTest.testCartesianProductTwoTypes for
	 * example output.
	 *
	 * @param left
	 *            fixed params
	 ...
	 * @param permutations
	 *            list of permutation to save results over recursive calls
	 * @param result
	 *            result of the last permutation
	 */
